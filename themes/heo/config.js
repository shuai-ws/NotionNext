const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-07-07', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到PM_成长研究所', url: 'https://www.gri.wang' },
    { title: '一个让产品经理终身学习的社区', url: 'https://www.gri.wang' }
  ],
  ...
  HEO_INFO_CARD_URL2: 'https://www.gri.wang',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_URL3: 'https://www.gri.wang',
  ...
  HEO_SOCIAL_CARD_URL: 'https://l2fauoo7uc.feishu.cn/docx/RxQPdDoEgoMtXuxNXnicplyzncf?from=from_copylink',
