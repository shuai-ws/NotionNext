...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'WangShuai', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的产品经理🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.gri.wang', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, PM_成长研究所', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一名产品经理, 欢迎来到我的网站,Hi，我是shuai,欢迎来到PM_成长研究所🎉',
